...
namespace ClassRegistration.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240606171503_Move_RegRecord_From_UserClass_To_Class")]
    partial class Move_RegRecord_From_UserClass_To_Class
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClassRegistration.Domain.Entities.RegistrationRecord", b =>
                {
                    ...
                    b.HasIndex("UserClassId")
                        .IsUnique()
                        .HasFilter("[UserClassId] IS NOT NULL");
            ...
            modelBuilder.Entity("ClassRegistration.Domain.Entities.RegistrationRecord", b =>
                {
                    ...
                    b.HasOne("ClassRegistration.Domain.Entities.UserClass", "UserClass")
                        .WithOne("RegistrationRecord")
                        .HasForeignKey("ClassRegistration.Domain.Entities.RegistrationRecord", "UserClassId");
